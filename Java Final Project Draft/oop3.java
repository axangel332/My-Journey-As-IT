	...
	public oop3() {
		...
		btnPlay.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println("AAA SOO BRIGHTT!!");
				int counter = 1;
				try {
					FileWriter writer = new FileWriter("SWITCH.txt");
					writer.write("\n-----SWITCH #" + counter + "------" + "\n");
					writer.write("THE LIGHT TURN ON\n");
					writer.write("SOOO BRIGHTT!!!\n");
					counter++;
					writer.close();
		...
		btnStop.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println("AAA SOO DARK!!");
				setBackground(new Color(0, 0, 0));
				int counter = 1;
				try {
					FileWriter writer = new FileWriter("SWITCH.txt");
					writer.write("\n-----SWITCH #" + counter + "------" + "\n");
					writer.write("THE LIGHT TURN OFF\n");
					writer.write("SOOO DARKK!!!\n");
					counter++;
					writer.close();
				} catch (IOException ex) {
					JOptionPane.showMessageDialog(null, "Error writing user information to file.");
