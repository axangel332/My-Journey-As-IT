...
public class PhonebookApp extends JFrame {
	...
	public PhonebookApp() {
		...
		scrollPane.setBounds(330, 113, 590, 435);
		...
		lblXBotton.setBounds(900, 0, 29, 29);
		PanelTop.add(lblXBotton);

		JLabel lblPhonebookTable = new JLabel("Food Supply");
		...
		JLabel Name = new JLabel("Supply_ID:");
		...
		nameField.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent e) {
				...
				if (Character.isDigit(character)) {
					e.consume(); // Consumes the event to prevent the integer
									// input
				}
			}
		...
		ageField.addKeyListener(new KeyAdapter() {
			public void keyTyped(KeyEvent e) {
				char character = e.getKeyChar();
				if (!Character.isDigit(character)) {
					e.consume(); // Consumes the event to prevent the
									// non-integer input
				}
			}
		...
		JLabel Address = new JLabel("Quantity:");
		...
		paneledit.setBounds(392, 607, 465, 42);
		...
		editButton.setBounds(501, 560, 99, 37);
		...
		deleteButton.setBounds(657, 560, 99, 37);
