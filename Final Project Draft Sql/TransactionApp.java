...
public class TransactionApp extends JFrame {
	private JTextField nameField, ageField, phoneField, addressField, zipcodeField, DateField, Payment_Cust;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TransactionApp frame = new TransactionApp();
	...
	public TransactionApp() {
		...
		model.addColumn("Trans_Id");
		model.addColumn("Order_Id");
		model.addColumn("Cust_Id");
		model.addColumn("Ship_Add");
		model.addColumn("Date");
		model.addColumn("Payment_Cust");
		...
		JLabel lblPhonebookTable = new JLabel("Transaction Report");
		...
		JLabel Phone = new JLabel("Cust_Id:");
		...
		JLabel Address = new JLabel("Ship_Add:");
		...
		JLabel Zipcode = new JLabel("Date:");
		...
		JLabel lblDate = new JLabel("Pay_Cost:");
		...
		addButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					writer.write("Date : " + Payment_Cust.getText() + "\n");
					counter++;
					writer.close();
