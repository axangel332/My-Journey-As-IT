...
public class CustomerApp extends JFrame {
	...
	public CustomerApp() {
		...
		Object[][] data = {
	            {1, "John Doe", "555-123-4567", "john.doe@example.com", "123 Main Street"},
	            {2, "Jane Smith", "555-987-6543", "jane.smith@example.com", "456 Elm Avenue"},
	            {3, "Bob Johnson", "555-555-5555", "bob.johnson@example.com", "789 Oak Lane"}
	        };
		...
		JLabel Name = new JLabel("Cust_ID:");
		...
		JLabel Zipcode = new JLabel("Address:");
		...
		addButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					writer.write("\n-----People #" + counter + "------" + "\n");
					writer.write("Cust_Id : " + nameField.getText() + "\n");
					writer.write("Cust_Name : " + ageField.getText() + "\n");
					writer.write("Phone_Num : " + phoneField.getText() + "\n");
					writer.write("Email : " + addressField.getText() + "\n");
					writer.write("Cust_Address : " + zipcodeField.getText() + "\n");
					counter++;
					writer.close();
