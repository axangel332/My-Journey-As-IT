...
public class OrderDetailsApp extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					OrderDetailsApp frame = new OrderDetailsApp();
	...
	public OrderDetailsApp() {
		...
		Object[][] data = { { 1, 1, 101, 2, 1001 }, { 2, 2, 102, 3, 1002 }, { 3, 3, 103, 1, 1003 } };
		...
		JLabel lblPhonebookTable = new JLabel("Order Details");
		...
		JLabel Name = new JLabel("Order_Id:");
		...
		JLabel Phone = new JLabel("Food_Id:");
		...
		JLabel Zipcode = new JLabel("Delivery_Id");
		...
		addButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int counter = 1;
				try {
					FileWriter writer = new FileWriter("OrderDetail.txt");
					writer.write("\n-----People #" + counter + "------" + "\n");
