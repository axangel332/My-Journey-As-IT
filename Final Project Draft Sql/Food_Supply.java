...
public class Food_Supply extends JPanel {
	...
	public Food_Supply() {
		...
		JLabel txtWelcome = new JLabel("Food Supply / Table");
		...
		JButton btnSubmit = new JButton("Enter Food Supply Tab");
		...
		btnSubmit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				FoodSupplyApp tables = new FoodSupplyApp();
